...
const BubbleContainer = (props) => {
  useEffect(() => {
    setBubbleEvent();
  }, [props.dataLitHue, props.dataLitCount]);
  ...
  return (
    <div
      data-lit-hue={props.dataLitHue}
      data-lit-count={props.dataLitCount}
      class="lit-container"
    >
      <div class={`minimal ${props.className || "bubbleList"}`}>
        {props.children}
      </div>
    </div>
  );
